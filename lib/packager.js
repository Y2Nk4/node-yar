...
var PackagerParses = {
	PackagerInterface: function(){
		this.pack = function(){
			throw new Error("Packager Class is not exist or doesn't provide a pack meothid");
			return;
		};
		this.unpack = function(){
			throw new Error("Packager Class is not exist or doesn't provide a unpack meothid");
			return;
		};
	},
