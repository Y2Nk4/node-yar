...
module.exports = function(){
	...
	this.pack = function(packageBody,Packager_Name = "JSON"){
		console.log(new Packager(Packager_Name).pack(packageBody));
	...
	this.unpack = function(pkg){
		...
		console.log(Pkg_Yar_Header[78]);
		console.log(Pkg_Yar_Header[79]);
		console.log(Pkg_Yar_Header[80]);
		console.log(Pkg_Yar_Header[81]);
		console.log(Pkg_Yar_Header[82]);
		return Package;
	};
}
